...
public class MemberController {
	...
	public String login(UserDTO userDTO, Model model, HttpSession httpSession) {	// DB에서 데이터를 가져온 사용ㅈ 정보
		
		
			UserDTO getUserDTO = UserDTO.builder().u_id("callor").u_password("12345").u_name("홍길동").u_tel("010-111-1111").build();
