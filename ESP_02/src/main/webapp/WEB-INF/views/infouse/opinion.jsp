    ...
    <section class="news_section">
        ...
        <article class="opinion_table">
            <table>
                <tr>
                    <th>제목</th>
                    <td><input name="opinion_submit" type="text" placeholder="내용을 입력해주세요"></input></td>
                </tr>
                <tr>
                    <th>이메일</th>
                    <td><input name="opinion_submit" type="email"  placeholder="내용을 입력해주세요"></td>
                </tr>
                <tr>
                    <th>내용</th>
                    <td><input name="opinion_submit" type="text"  placeholder="내용을 입력해주세요"></td>
                </tr>
            </table>
            <div>
                <a href="${rootPath}/"><button>등록</button></a>
            </div>
        </article>
    </section>
