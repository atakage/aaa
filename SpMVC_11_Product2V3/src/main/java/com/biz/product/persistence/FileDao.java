...
public interface FileDao {
	...
	public void filesDelete(List<ProFileDTO> files);		// 파일을 개별적으로 삭제
	public void fileDelete(long file_seq);			// 다수의 파일을 삭제, 여러개의 파일을 선택해서 삭제
	...
	// 상품정보가 삭제되었을 때 삭제
    // 상품 테이블과 파일테이블을 외래키 연관을 해두면 상품테이블의 레코드가 삭제될 때 파일 테이블의 정보를 삭제할 수 있음
	// 여러개의 파일일 경우 특별한 상황이 아니면 파일 정보를 update하는 것은 거의 없음
